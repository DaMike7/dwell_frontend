...
export default function Content(){
    ...
    return (
        ...
        <div>
            {/*RIGHT*/}
            <div className="bg-gradient-to-r from-slate-300 to-slate-500 dark:bg-gray-900">
                <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
                    <div className="font-medium text-gray-700 sm:text-lg dark:text-gray-400">
                        <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white"> Unlocking Your Next Chapter in Real Estate</h2>
                        <p className="mb-4"> Discerning buyers deserve an exceptional experience.  At Dwell, our team of luxury real estate specialists provides unparalleled access to exclusive properties, coupled with in-depth market knowledge and a personalized approach.  We meticulously curate a selection of properties that align with your vision, guiding you through every step of the acquisition process to ensure you secure your ideal estate.</p>
                    </div>
                    <div className="grid grid-cols-2 gap-4 mt-8">
                        <img className="w-full rounded-lg" src="https://res.cloudinary.com/delagynow/image/upload/v1711150031/site_photo%20archive/hey_oaa8qu.jpg" alt="office content 1"/>
                        <img className="mt-4 w-full lg:mt-10 rounded-lg" src="https://res.cloudinary.com/delagynow/image/upload/v1711150031/site_photo%20archive/1n_xmvfvn.jpg" alt="office content 2"/>
                    </div>
                </div>
            </div>
            {/*lEFT*/}
            <div className=" bg-gradient-to-r from-slate-300 to-slate-500">
                <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
                    ...
                    <div className="grid grid-cols-2 gap-4 mt-8">
                        <img className="w-full rounded-lg" src="https://res.cloudinary.com/delagynow/image/upload/v1711150131/site_photo%20archive/9_ux8p4n.jpg" alt="office content 1"/>
                        <img className="mt-4 w-full h-34 lg:mt-10 rounded-lg" src="https://res.cloudinary.com/delagynow/image/upload/v1711151763/site_photo%20archive/DSC00919-1_mkcgpd.webp" alt="office content 2"/>
                    </div>
                    <div className="font-light text-gray-700 sm:text-lg dark:text-gray-400">
                        <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Experience Seamless Real Estate Transitions</h2>
                        <p className="mb-4">We're a team of passionate real estate professionals dedicated to simplifying your home buying or selling journey. Our expertise and streamlined approach ensure you find the perfect property, or get the most value from your existing one, without the hassle.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-slate-300 to-slate-500 dark:bg-gray-900">
                <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
                    <div className="font-light text-gray-700 sm:text-lg dark:text-gray-400">
                        ...
                        <p className="mb-4">At Dwell, we're driven by a passion for connecting people with their dream properties. We combine strategic expertise, innovative marketing solutions, and a streamlined approach to navigate you through the complexities of the real estate market. Whether you're buying, selling, or investing, our team of dedicated professionals ensures a smooth and successful experience, tailored to your unique needs.</p>
                    </div>
                    <div className="grid grid-cols-2 gap-4 mt-8">
                        <img className="w-full rounded-lg" src="https://images.propertypro.ng/large/luxury-2bedroom-flats-gym-THTx5FTlkoacHLMeDVyP.png" alt="office content 1"/>
                        <img className="mt-4 w-full lg:mt-10 rounded-lg" src="https://images.propertypro.ng/large/HJnfK-brand-new-two-bedroom-apartment-pent-floor--wOLip4TC22pshkcni6ro.jpeg"/>
                    </div>
                </div>
            </div>
    

            <section class="bg-gradient-to-r from-slate-300 to-slate-500 dark:bg-gray-900">
            <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                
                <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Your Trusted Partner in Real Estate Succes</h1>
                <p class="mb-8 text-lg font-normal text-gray-700 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400"> We build trusted relationships with our clients, providing personalized support and expert guidance throughout the entire real estate journey.  Our commitment extends beyond the closing, ensuring you achieve success in every stage of your real estate goals.</p>
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="max-w-screen-md mb-8 lg:mb-16">
          ...
          <p class="text-gray-500 sm:text-xl dark:text-gray-400">Here at Dwell we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
      </div>
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Different</h3>
              <p class="text-gray-500 dark:text-gray-400">Excellence is not just a goal; it's our standard at Dwell,we standout from the crowd to provide you with the best of all.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p class="text-gray-500 dark:text-gray-400">We operate legally and transparentlly just to offer our services to you.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p class="text-gray-500 dark:text-gray-400">Our platform provides you with the best properties that matches your budgets.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p class="text-gray-500 dark:text-gray-400">Our platform is always up to date with properties having the latest design.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
            ...
            <section class="bg-gradient-to-r from-slate-300 to-slate-500">
                <div class="py-8 px-4 mx-auto max-w-screen-xl text-center  lg:py-16 lg:px-6">
                    <div class="mx-auto max-w-screen-sm">
                        <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Testimonials</h2>
                        <p class="mb-8 font-medium text-gray-700 lg:mb-16 sm:text-xl dark:text-gray-400">Explore what users has to say about us</p>
                    </div> 
                    <div className=" grid mb-8 lg:mb-12 lg:grid-cols-2">
                        <figure class="bg-sky-50 font-semibold flex flex-col justify-center items-center p-8 text-center  border-b border-gray-200 md:p-12 lg:border-r dark:bg-gray-800 dark:border-gray-700">
                        <blockquote class="mx-auto mb-8 max-w-2xl text-gray-600 dark:text-gray-400">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Speechless with how easy it was to find my dream apartment</h3>
                        <p class="my-4">"I recently finished my service and i was gonna need a new apartment , i was literally worried about how i'm gonna rent a new apartment ,then i saw Dwell's twitter page and right there was the apartment i've always wanted at a my budget price </p>
                        <p class="my-4">Dwell has the best apartmentyou would think of and I'm not joking when I say it took me a matter of minutes to find an apartment and reached out to the agent . thanks to the chat feature</p>
                        <p class="my-4">If you care for your time, I hands down would go with this."</p>
                        </blockquote>
                        <figcaption class="flex justify-center items-center space-x-3">
                        <img class="w-9 h-9 rounded-full" src="https://www.artrichphotography.com/wp-content/uploads/2023/06/0670.jpg" alt="profile picture"/>
                        <div class="space-y-0.5 font-medium dark:text-white text-left">
                            <div>Tim Blake</div>
                            </div>
                            </figcaption>    
                            </figure>
          <figure class="flex flex-col justify-center items-center p-8 text-center bg-sky-50 font-semibold border-b border-gray-200 md:p-12 dark:bg-gray-800 dark:border-gray-700">
              <blockquote class="mx-auto mb-8 max-w-2xl text-gray-600 dark:text-gray-400">
                  <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Solid foundation for new couples</h3>
                  <p class="my-4">"I can't thank this website enough for making my home search incredibly smooth and efficient! The chat feature was a lifesaver; it allowed me to communicate directly with agents and get instant responses to all my queries. With its user-friendly interface and extensive property listings, I was able to narrow down my options quickly and find the perfect home for my family.</p>
                  <p class="my-4">I highly recommend this platform to anyone in search of their dream property!"</p>
              </blockquote>
              <figcaption class="flex justify-center items-center space-x-3">
                  <img class="w-9 h-9 rounded-full" src="https://www.artrichphotography.com/wp-content/uploads/2018/07/senior-photography-classic-in-school-img18.jpg" alt="profile picture"/>
                  <div class="space-y-0.5 font-medium dark:text-white text-left">
                      <div>Roberta Casas</div>
                  </div>
              </figcaption>    
          </figure>
          <figure class="flex flex-col justify-center items-center p-8 text-center bg-sky-50 font-semibold border-b border-gray-200 lg:border-b-0 md:p-12 lg:border-r dark:bg-gray-800 dark:border-gray-700">
              <blockquote class="mx-auto mb-8 max-w-2xl text-gray-600 dark:text-gray-400">
                  <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Mindblowing workflow</h3>
                  <p class="my-4">"As a busy professional, I don't have time to waste browsing through endless property listings. That's why I turned to this real estate website—and I'm so glad I did! The chat feature allowed me to communicate directly with agents and discuss my specific needs and preferences. Within minutes, I was presented with a curated list of properties that matched my criteria perfectly. Thanks to this website, I was able to find my new home quickly and with minimal hassle.</p>
                  <p class="my-4">I can't recommend it enough!"</p>
              </blockquote>
              <figcaption class="flex justify-center items-center space-x-3">
                  <img class="w-9 h-9 rounded-full" src="https://www.artrichphotography.com/wp-content/uploads/2018/07/senior-photography-classic-in-school-img7.jpg" alt="profile picture"/>
                  <div class="space-y-0.5 font-medium dark:text-white text-left">
                      <div>Jese Leos</div>
                  </div>
              </figcaption>    
          </figure>
          <figure class="flex flex-col justify-center items-center p-8 text-center bg-sky-50 font-semibold border-gray-200 md:p-12 dark:bg-gray-800 dark:border-gray-700">
              <blockquote class="mx-auto mb-8 max-w-2xl text-gray-600 dark:text-gray-400">
                  <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Effortless Rental Experience with Real-Time Assistance</h3>
                  <p class="my-4">"Finding the perfect commercial space for my business was a daunting task, but this real estate website made it surprisingly easy. The chat support was instrumental in helping me navigate the complexities of commercial leasing, providing valuable insights and assistance every step of the way. With their help, I was able to find a space that not only met my requirements but also fit within my budget"</p>
                  <p class="my-4">I'm incredibly grateful for the level of service provided by this website and would highly recommend it to anyone in need of commercial real estate solutions!"</p>
              </blockquote>
              <figcaption class="flex justify-center items-center space-x-3">
                  <img class="w-9 h-9 rounded-full" src="https://www.artrichphotography.com/wp-content/uploads/2023/06/0142.jpg" alt="profile picture"/>
                  <div class="space-y-0.5 font-medium dark:text-white text-left">
            ...
            <div className="bg-gradient-to-r from-slate-300 to-slate-500" id="signup-section">
            <div class="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                <Link to="/signup/tenants" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-gradient-to-r from-indigo-500 to-blue-500 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                Sign Up As A Tenant
                <svg class="ml-2 -mr-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                </Link>
                <Link to="/signup/property-owners" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                Signup As A Property Owner
                <svg class="ml-2 -mr-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                </Link>
            </div>
            <section class="bg-sky-50 dark:bg-gray-900">
